...
describe('Linking tests', () => {
    test('linking of greetings', async () => {
        ...
        checkDocumentValid(document)
            || document.parseResult.value.greetings.map(g => { var _a, _b; return ((_a = g.person.ref) === null || _a === void 0 ? void 0 : _a.name) || ((_b = g.person.error) === null || _b === void 0 ? void 0 : _b.message); }).join('\n')).toBe(s `
            Langium
        `);
    });
});
